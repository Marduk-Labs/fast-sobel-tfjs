...
export {
    getAvailableKernelSizes, isValidKernelSize
} from './kernels';

export {
    getAvailableOutputFormats, isValidOutputFormat
} from './processors';
...
export function createSobelFilterFactory(defaultOptions: SobelOptions) {
    return function createFilter(overrideOptions?: Partial<SobelOptions>) {
        const { SobelFilter } = require('./sobel');
...
export {
    ...
    processHTMLImage, tensorToImageData
} from './utils';
